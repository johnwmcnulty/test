...
export const FirstTimeLogin: React.FC<FirstTimeLoginProps> = ({ onSubmit, isLoading, email, onReset }) => {
  ...
  return (
    <Card>
      <h2 className="text-xl font-semibold text-center text-gray-900 mb-2">Welcome, {email}</h2>
      <p className="text-sm text-center text-gray-500 mb-6">Your account has been created. To get started, please set a permanent password. Your temporary password, sent via email, is valid for 7 days.</p>
      
      <WelcomeEmailPreview email={email} onReset={onReset} />
